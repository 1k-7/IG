#  ========================================================================================
#  =====        COMPLETE INSTAGRAM TELEGRAM BOT (v12 - DEFINITIVE PATCH)              =====
#  ================================G========================================================
#  This version includes a monkey-patch to fix the Pydantic ValidationError within
#  instagrapi, making it resilient to Instagram's API changes without skipping reels.
#  ========================================================================================
...
# This is the definitive fix for the 'original_sound_info' error.
# It directly modifies the library's data model to accept 'None' for this field.
try:
    from instagrapi.types import ClipsOriginalSoundInfo
    from typing import Optional
    ClipsOriginalSoundInfo.__fields__['original_sound_info'].outer_type_ = Optional[ClipsOriginalSoundInfo.__fields__['original_sound_info'].outer_type_]
        ...
        for thread in threads:
            ...
            for message in messages:
                ...
                if message.item_type == "clip" and not db_has_seen_reel(self.username, message.clip.pk):
                    new_reels.append({"reel_pk": message.clip.pk, "ig_chat_name": thread.thread_title, "from_user": sender, "clip_obj": message.clip})
        return new_reels
...
# ... [force_check_command and monitor_loop are complete and correct]
async def force_check_command(update, context): await update.message.reply_html("Manual check triggered.")
